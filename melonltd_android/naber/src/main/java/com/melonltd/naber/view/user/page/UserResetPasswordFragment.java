...
public class UserResetPasswordFragment extends Fragment implements View.OnClickListener {
//    private static final String TAG = UserResetPasswordFragment.class.getSimpleName();
    public static UserResetPasswordFragment FRAGMENT = null;
    ...
    public Fragment getInstance(Bundle bundle) {
        if (FRAGMENT == null) {
            FRAGMENT = new UserResetPasswordFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_user_reset_password, container, false);
        ...
        if (UserMainActivity.toolbar != null) {
            UserMainActivity.navigationIconDisplay(true, new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    UserAccountDetailFragment.TO_RESET_PASSWORD_INDEX = -1;
                    UserMainActivity.removeAndReplaceWhere(FRAGMENT, PageType.USER_ACCOUNT_DETAIL, null);
